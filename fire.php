    <?php 
    $title = "Fire Detection Safety Security Systems | Kaykar CCTV";
    ...
    <?php include('inc/nav.php'); ?>
        ...
        <div class="container-fluid page-header py-5 mb-5">
            <div class="container py-5">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Fire Detection and Safety Security Systems</h1>
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-white" href="/">Home</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Fire Detection and Safety Security Systems</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="container text-center">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        ...
                        <h1 class="display-1">Fire Detection and Safety Security Systems</h1>
